...
class MyAdapter(val context: Activity, val dataList: List<Data>?): RecyclerView.Adapter<MyAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        //create the view in case of the layout manger  fails to cretae view for the data
...
//populate thedata into the view
    ...
    class MyViewHolder(itemView: View): RecyclerView.ViewHolder (itemView){
        ...
        init {
            image= itemView.findViewById(R.id.muiscImage)
